...
1. Generate a skeleton course directory structure.
   ...
   : ./add_course create seattle-intro

   This will create a =seattle-intro/= directory in your current
   working directory.  Inside will be a =course_config.yaml= file that
   will look like this:
