...
0. Run =./scripts/add_event= from the top-level of your webiste
   Subversion working copy
1. Run =./scripts/add_event EVENT_NAME=
   This will create two files (EVENT_NAME.yaml and EVENT_NAME.html) 
   in the =./content/evnets/= directory
3. Inside the default =EVENT_NAME.yaml= file will look like this:
   #+begin_src yaml
...
5. Use svn to commit changes and additions by =add_event=
