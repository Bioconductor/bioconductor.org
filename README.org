...
The bioconductor-test.fhcrc.org test site currently runs on
merlot2.fhcrc.org.  The biocadmin user's crontab is used to schedule
...
*** Start apache using /etc/init.d/apache2 restart
