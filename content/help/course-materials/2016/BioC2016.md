...
[CONFERENCE SURVEY]: https://www.surveymonkey.com/r/8F8GNQ6
...
data. 'Developer Day' (developer day registration is <font
color="red">closed</font>; registrations received after 2 June do not
include developer day) precedes the main conference on June 24,
...
- June 24: Developer Day, [Clark Center][] Room S360. 9am to 5pm.
- June 25 - 26: Main Conference, [Li Ka Shing Learning and Knowledge Center][]

Main conference registration is <font color="red">closed</font>.
...
* Start the instance <%= ami_url("ami-ee35f883") %>; See the [documentation for this](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/launching-instance.html). Make sure your [security group](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html) has
port 80 accessible.
...
- 10:00 - 11:15 Lightning talks 1
    ...
    - Edward Lee. Obtaining T cell receptor pairs from high-throughput
      sequencing data using the alphabetr package [[slides](LightningTalks1/ed_lee_bioconductor.pdf)]
    - Rene Welch. A Quality Control pipeline for ChIP-exo and
      ChIP-nexus [[slides](LightningTalks1/ReneWelch_Bioc2016_lightning_talk-1.pdf)]
    - Caleb Lareau. Uncovering and Visualizing Differential Topological
      Domains in DNA [[slides](http://rpubs.com/calablareau/191758)]
    - Thomas Girke. Experience teaching R / Bioconductor in graduate
      classes. [[slides](LightningTalks1/Girke_R-Bioconductor_in_Classroom.pdf)]
...
- 11:30 - 12:30 Lightning talks 2
    ...
    - Michael Steinbaugh. Sharing genome-wide screening and RNA-seq
      experiments in reproducible data packages using R/Bioconductor. [[slides](LightningTalks2/SteinbaughBioC2016.pdf)]
    ...
    - Peter Hickey. New stuff in bsseq for analysing large whole genome
      bisulfite-sequencing datasets [[slides](http://peterhickey.org/bioc2016-lightning-talk.html)]
...
- 2:00 - 2:45 Lightning workshops 1
    ...
    - Accessing ISB Cancer Genomics Cloud Resources (Vince Carey) [[setup notes](LightningWorkshop1/TCGABigQuerysetupforBiocConferenceAMIs.pdf)] [ [cgcR package](https://github.com/teamcgc/cgcR) or [Vince's fork of cgcR](https://github.com/vjcitn/cgcR/) ] [[strategies](LightningWorkshop1/160624-carey-isbbig.pdf)]
...
- 3:15 - 4:00 Lightning workshops 2
    ...
    - GenomicRanges for developers (Herv&eacute; Pag&egrave;s) [[slides](LightningWorkshops2/Ten_things_slides.pdf)]
    - Unit tests and other approaches to writing robust packages (Jim Hester) [[Bioconductor Testing Guidelines](http://bioconductor.org/developers/unitTesting-guidelines/)] [[testthat](http://r-pkgs.had.co.nz/tests.html)]
    - Common pitfalls in R, and how to avoid them [[github](https://github.com/Bioconductor/DDayChallenge)]
...
- Speakers
  ...
  - 8:30 - 9:15. Sandrine Dudoit, Stanford University. 
