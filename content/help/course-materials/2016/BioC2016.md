...
- 9:00 - 9:45 Introductions; Project and Other Updates
- 9:45 - 10:00 Group activity
- 10:00 - 10:30 Lightning talks 1

    - Edward Lee. Obtaining T cell receptor pairs from high-throughput
      sequencing data using the alphabetr package
    - Rene Welch. A Quality Control pipeline for ChIP-exo and
      ChIP-nexus
    - Caleb Lareau. Uncovering and Visualizing Differential Topological
      Domains in DNA
    - Wolfgang Huber. Independent Hypothesis Weighting
    - Thomas Girke. Experience teaching R / Bioconductor in graduate
      classes.

- 10:30 - 11:00 BREAK

- 11:00 - 11:30 Lightning talks 2

    - Michael Lawrence. Hello, Ranges
    - Michael Steinbaugh. Sharing genome-wide screening and RNA-seq
      experiments in reproducible data packages using R/Bioconductor.
    - Marcin Kosi&#324;ski. Integrating TCGA Data - RTCGA Workflow
    - Lucas Schiffer. Curated TCGA Data - A MultiAssayExperiment Teaser
    - Peter Hickey. New stuff in bsseq for analysing large whole genome
      bisulfite-sequencing datasets

- 11:30 - 12:00 Facilitated Discussion: Approaches to Data Modeling
- 12:00 - 12:30 Lightning talks 3

    - Richie Cotton. readat: Read and work with SomaLogic ADAT files
    - Benjamin Haibe-Kains. Reproducible research, algorithms, and data
    - Wolfgang Huber. Updated BiocStyle for PDF and HTML vignettes
    - Karim Chine. Bioconductor on the rosettaHUB community platform

- 12:30 - 1:30 LUNCH (NOT PROVIDED)

- 1:30 - 2:30 Lightning workshops 1

    - Making Interactive Packages (Sean Davis)
    - Unit tests and other approaches to writing robust packages (Jim Hester)
    - Accessing Google Genomics Resources (Vince Carey)

- 2:30 - 3:30 Interactive Visualization

- 3:00 - 3:30 BREAK

- 3:30 - 4:00 Lightning workshops 2

    - GenomicRanges for developers (Herv&eacute; Pag&egrave;s)
    - Common pitfalls in R, and how to avoid them

- 4:00 - 4:15 Facilitated Discussion: Greatest Needs (Martin Morgan)
- 4:15 - 5:00 Developer Day Keynote Address. Dr. Robert Gentleman,
...
- Speakers
  ...
  - 8:30 - 9:15. Sandrine Dudoit, Berkeley University. Identification
