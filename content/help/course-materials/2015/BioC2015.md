...
**Conference Survey**: [http://goo.gl/forms/NOi0dz8Wmx](http://goo.gl/forms/NOi0dz8Wmx)
...
* Start the instance <%= ami_url("ami-b1f221da") %>; See the [documentation for this](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/launching-instance.html). Make sure your [security group](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html) has
port 80 accessible.
...
- 10:30 - 11:15: [Karl Broman](http://kbroman.org/), University of
  Wisconsin,
  Madison. [Interactive graphics for genetic data](http://bit.ly/BioC2015).
...
- Aaron Lun.  Detecting differentially bound regions in ChIP-seq data
  ...
  Slides: [HTML](csaw_lab.html), [Rmd](csaw_lab.Rmd), [R](csaw_lab.R), [GitHub](https://github.com/LTLA/aaronlab)
...
- Andrzej Oles, Wolfgang Huber. Basics of image data and spatial
  ...
  Slides: [HTML](BioC2015Oles.html), [Rmd](BioC2015Oles.Rmd), [R](BioC2015Oles.R), [GitHub](https://github.com/aoles/BioC2015Oles)
...
- _Bioconductor_ Core Team. An introduction to _R_ and _Bioconductor_.
  ...
  Slides: [GitHub](https://github.com/Bioconductor/BioC2015Introduction)

  Part I: Introduction to R [HTML](V1-Introduction.html), [Rmd](V1-Introduction.Rmd), [R](V1-Introduction.R)

  Part II: Introduction To Bioconductor [HTML](V2-IntroductionBioconductor.html), [Rmd](V2-IntroductionBioconductor.Rmd), [R](V2-IntroductionBioconductor.R)

  Part III: Lab: Basic Bioconductor [HTML](V3-Lab-BasicBioconductor.html), [Rmd](V3-Lab-BasicBioconductor.Rmd), [R](V3-Lab-BasicBioconductor.R)

  Part IV: Lab: Intermediate Bioconductor [HTML](V4-Lab-IntermediateBioconductor.html), [Rmd](V4-Lab-IntermediateBioconductor.Rmd), [R](V4-Lab-IntermediateBioconductor.R)

  Part V: Advanced Lab: Explore the Data  [HTML](V5-Lab-Advanced-ExploreData.html), [Rmd](V5-Lab-Advanced-ExploreData.Rmd), [R](V5-Lab-Advanced-ExploreData.R)

  Part VI: Advanced RnaSeq [HTML](V6-Lab-Advanced-RnaSeq.html), [Rmd](V6-Lab-Advanced-RnaSeq.Rmd), [R](V6-Lab-Advanced-RnaSeq.R)
...
- Dan Tenenbaum, Tengfei Yin,  Nan Xiao. Working with _Docker_
  ...
  Slides: [HTML](docker_and_bioconductor.html), [Rmd](docker_and_bioconductor.Rmd), [R](docker_and_bioconductor.R), [GitHub](https://github.com/Bioconductor/docker.workshop)
  ...
  liftr & sbgr: [PDF](bioc2015-workshop-nanxiao.pdf), [Video](https://www.youtube.com/watch?v=D1-l0Noa3Ho)
...
- Greg Finak. Gating Designed Experiments With
  ...
  Slides: [GitHub](https://github.com/gfinak/BioC2015OpenCyto)

  Visualize Cytometry data with ggCyto: [HTML](ggcyto.html), [Rmd](ggcyto.Rmd), [R](ggcyto.R)

  Analysis of Designed Experiments Using OpenCyto: [HTML](OpenCytoWorkshop.html), [Rmd](OpenCytoWorkshop.Rmd), [R](OpenCytoWorkshop.R)
...
- Herv&eacute; Pag&egrave;s, Michael Lawrence. Practical introduction
  ...
  [PDF](/packages/3.2/bioc/vignettes/GenomicRanges/inst/doc/GRanges_and_GRangesList_slides.pdf), [R](/packages/3.2/bioc/vignettes/GenomicRanges/inst/doc/GRanges_and_GRangesList_slides.R)
...
- James MacDonald. FAQ Live! Common questions and expert solutions,
  ...
  Slides: [PDF](BioC2015.pdf), [Rnw](BioC2015.Rnw), [R](BioC2015.R), [GitHub](https://github.com/jmacdon/MacDonaldBioC2015)
...
- Kasper Hansen. Methylation and the analysis of Illumina 450k
  ...
  Slides: [HTML](methylation450k.html), [Rmd](methylation450k.Rmd), [R](methylation450k.R), [GitHub](methylation450k.html)
...
- Leonard Goldstein [SGSeq](http://bioconductor.org/packages/SGSeq)
  ...
  Slides: [HTML](SGSeqBioC2015.html), [Rmd](SGSeqBioC2015.Rmd), [R](SGSeqBioC2015.R), [GitHub](https://github.com/ldg21/SGSeqBioC2015)
...
- Levi Waldron, Tim Triche, Aedin Culhane. Challenges and
  ...
  Slides: [GitHub](https://github.com/lwaldron/bioc2015multiomicsworkshop)

  multiAssayQC: [HTML](multiAssay.html), [Rmd](multiAssay.Rmd), [R](multiAssay.R)

  TCGAloading: [HTML](TCGAloading.html), [Rmd](TCGAloading.Rmd), [R](TCGAloading.R)
...
- Marc Carlson, Sonali Arora. _Bioconductor_ annotation resources.
  ...
  Slides: [GitHub](https://github.com/mrjc42/BiocAnnotRes2015)

  Annotation Resources for Bioconductor: [HTML](Annotation_Resources.html), [Rmd](Annotation_Resources.Rmd), [R](Annotation_Resources.R)

  AnnotationHub Recipes: [HTML](AnnotationHubRecipes.html), [Rmd](AnnotationHubRecipes.Rmd), [R](AnnotationHubRecipes.R)
...
- Mike Love. Differential expression, manipulation, and visualization
  ...
  Slides: [HTML](bioc2015rnaseq.html), [Rmd](bioc2015rnaseq.Rmd), [R](bioc2015rnaseq.R), [GitHub](https://github.com/mikelove/bioc2015rnaseq)
...
- Nicole Deflaux, Siddhartha Bagaria and Craig Citro,
  ...
  Slides: [GitHub](https://github.com/googlegenomics/bioconductor-workshop-r), [readthedocs](https://googlegenomics.readthedocs.org/en/latest/workshops/bioc-2015.html)
...
- Thomas Girke. Automated NGS workflows with
  ...
  Slides: [GitHub](https://github.com/tgirke/systemPipeRdata)

  systemPipeRdata: [PDF](systemPipeRdata.pdf), [Rnw](systemPipeRdata.Rnw), [R](systemPipeRdata.R)

  systemPipeR: NGS Workflow and Reporting Environment [HTML](systemPipeR_Presentation.html), [Rmd](systemPipeR_Presentation.Rmd), [R](systemPipeR_Presentation.R)
...
- Valerie Obenchain, Martin Morgan, et al. Management
  ...
  Slides: [HTML](LargeData.html), [Rmd](LargeData.Rmd), [R](LargeData.R), [GitHub](https://github.com/Bioconductor/BioC2015LargeData)
...
- Jianhong Ou, Scot A. Wolfe, Michael H. Brodsky and Lihua J. Zhu, University
  of Massachusetts. motifStack: A Tool to Visualize Sequence Logo Alignments.

  Sequence motifs represent conserved characteristics within sets of related
  aligned sequences such as DNA binding sites for transcription factors (TFs)
  or amino acid patterns within related protein domains. To explore the
  functional and evolutionary relationships between proteins with related
  functions, tools are required to describe patterns and relationships within
  large collections of sequence motifs. We developed a flexible open-source
  R/Bioconductor package, motifStack, to display and annotate aligned sequence
  motifs. We use motifStack to visualize and compare three collections of
  motifs describing the DNA binding specificities of homeodomain transcription
  factors. We find that differences in the experimental and computational
  methods used to generate motifs can have a greater influence on motif
  alignments than differences in protein sequence. A comparison of motifs
  determined by different methods reveals an expected substantial overlap in
  motifs from mammalian and fly homeodomains. However, we also use motifStack
  to identify examples of species-specific homeodomain binding specificities. 

- Sarah Sheppard, Jianhong Ou, Nathan Lawson and Lihua Julie Zhu, University
  of Massachusetts. cleanUpdTSeq: Application of a naïve Bayes classifer to 
  accurately assign polyadenylation sites from 3&prime; end deep sequencing data.

  3&prime; end processing is important for transcription termination, mRNA
  stability, and regulation of gene expression.  To identify 3&prime; ends, most
  techniques utilize an oligo-dT primer to construct deep sequencing libraries.
  However, this approach can lead to identification of artifactual
  polyadenylation sites due to internal priming in homopolymeric stretches of
  adenines.  By analyzing sequence features flanking 3&prime; ends derived from
  oligo-dT based sequencing, we developed a naïve Bayes classifier, implemented
  as cleanUpdTSeq package, to classify them as true or false/internally primed.
  The resulting algorithm is highly accurate and facilitates identification of
  novel polyadenylation sites.
