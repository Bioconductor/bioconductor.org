...
- Dan Tenenbaum, Tengfei Yin. Working with _docker_ and _AMI_
  ...
  Part II: We will introduce common workflow language and the
  implementation with rabix briefly, then a demo about how to make
  your R script or function into CWL, how to use rabix to develop your
  tools with docker container, deploy and run it on AWS cloud with SBG
  platform or run it locally, and how to automate a workflow from data
  uploading to pipeline running with sbgr API package.
