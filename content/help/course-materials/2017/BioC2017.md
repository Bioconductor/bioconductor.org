...
<p><font color="red">Registration FULL</font>. Unfortunately,
registration is completely full.</p>
...
[The Inn at Longwood]: http://www.innatlongwood.com
[Courtyard Marriott Brookline]: http://www.marriott.com/meeting-event-hotels/group-corporate-travel/groupCorp.mi?resLinkData=Dana%20Farber%20Bioconductor%5EBOSBL%60DFBDFBA%60229%60USD%60false%601%607/25/17%607/28/17%607/7/17&app=resvlink&stop_mobi=yes
...
development-oriented work shops, and additional activities. Yawkey 306
/ 307 and breakout rooms

[Current schedule available][dday-schedule]

[dday-schedule]: https://goo.gl/ekmG33

## Main Conference, Thursday - Friday, July 27 - 28.

**Morning Talks** consist of 45 and 30 minute 'invited speaker' and
...
- 8:30 - 9:15 [Christina Kendziorski][] (University of Wisconsin) --
  Statistical methods for single-cell RNA-seq data.
- 9:15 - 10:00 [Rahul Satija][] (New York Genome Center, NYU) --
  Challenges and opportunities in analysis of single cell
  transcriptomics.
- 10:00 - 10:30 Break
- 10:30 - 11:15 [James Lindsay][] (Dana-Farber Cancer Institute) --
  Knowledge Systems at Dana Farber.
- 11:15 - 11:30 [Stephanie Hicks][] (Dana-Farber Cancer Institute) --
  Estimating cell type composition in whole blood using differentially
  methylated regions.
- 11:30 - 11:45 [Stephen Piccolo][] (Brigham Young University) --
  Comprehensive benchmark of supervised-learning algorithms for
  predicting cancer states.
- 11:45 - 12:00 [Nils Gehlenborg][] (Harvard Medical School) --
  Relaxation Techniques for the Upset Data Scientist.

July 28 -- Jimmy Fund Auditorium

- 8:30 - 9:15 [Elham Azizi][] (Memorial Sloan Kettering) -- Bayesian
  inference for single-cell clustering and imputing.
- 9:15 - 10:00 [Martin Aryee][] (Harvard) -- Analyzing 3-dimensional
  genome topology data.
- 10:00 - 10:30 Break
- 10:30 - 11:00 [Davis McCarthy][] (EBI, Cambridge, UK) -- Using _R_
  and _Bioconductor_ to explore genetic effects on single-cell gene
  expression.
- 11:00 - 11:30 [Raphael Gottardo][] (Fred Hutchinson Cancer Research
  Center) -- Statistical methods for the analysis of flow cytometry
  data.
- 11:30 - 11:45 [Keegan Korthauer][] (Dana-Farber Cancer Institute) --
  An _R_ package for detection and inference of differentially
  methylated regions from bisulfite sequencing.
- 11:45 - 12:00 [Jeff Gentry][] (Broad Institute) -- Cromwell & WDL:
  Bioinformatics pipelines at any scale.
...
- Infrastructure for efficient storage and processing of large-scale
  single-cell genomics data. Davide Risso (Division of Biostatistics
  and Epidemiology, Weill Cornell Medical College) et al. Yawkey 306.
- Teaching / training using _Bioconductor_ packages. Jenny
  Drnevich (University of Illinois), Radhika Khetani (Harvard
  T.H. Chan School of Public Health). Yawkey 307.

July 28 (Lunch)

- Analyzing publicly available cancer genomics data from GTEx and TCGA
  with _Bioconductor_. Sonali Arora (Fred Hutchinson
  Cancer Research Center, Seattle). Yawkey 306.
...
- Introduction to _R_ and _Bioconductor_. Lori Shepherd (Roswell Park
  Cancer Institute). Yawkey 308.
- A Journey of Discovery through the GenomicRanges
  Infrastructure. Michael Lawrence (Genentech). Yawkey 307.
- Microbiome Data Analysis. Levi Waldron (CUNY School of Public
  Health) et al. Yawkey 306.
- Design and evaluate guide RNAs for CRISPR-Cas9 genome-editing using
  CRISPRseek and GUIDEseq. Lihua Julie Zhu (University of
  Massachusetts Medical School). Smith 308.

July 27, 3:15 - 5:00

- Differential Gene Expression analysis using _R_ /
  _Bioconductor_. Radhika Khetani (Harvard T. H. Chan School of Public
  Health) et al. Yawkey 306.
- Interactive visualization and Data Analysis with epiviz web
  components. Jayaram Kancherla (University of Maryland, College Park)
  et al. Yawkey 308.
- Functional enrichment analysis of high-throughput omics data in
  _Bioconductor_. Ludwig Geistlinger, Levi Waldron (CUNY School of
  Public Health). Smith 308.
- Learn to leverage 70,000 human RNA-seq samples for your
  projects. Leonardo Collado Torres (Lieber Institute for Brain
  Development). Yawkey 307.

July 28, 1:00 - 2:45


- Ensemble gene set enrichment analysis with *EGSEA*. Matt Ritchie
  (Walter and Eliza Hall Institute of Medical
  Research). Yawkey 306. <font color="red">schedule change</font>
- _Bioconductor_ workflow for single-cell RNA-seq data analysis:
  dimensionality reduction, clustering, and pseudotime ordering. Fanny
  Perraudeau (Division of Biostatistics, School of Public Health,
  University of California, Berkeley, CA, USA) et al. Yawkey 307.
- Integrative analysis workshop with TCGAbiolinks and ELMER. Tiago
  Chedraoui Silva (University of São Paulo / Cedars-Sinai) et
  al. Yawkey 308.
- CyTOF workflow: differential discovery in high-throughput
  high-dimensional cytometry datasets. Malgorzata Nowicka (University
  of Zurich) et al. Smith 308.

July 28, 3:15 - 5:00

- Understanding _Bioconductor_ Annotation Packages. James MacDonald
  (University of Washington). Yawkey 306. <font color="red">schedule
  change</font>
- Variant Annotation Workshop with FunciVAR, StateHub and
  MotifBreakR. Dennis J Hazelett (Cedars-Sinai Medical Center), Simon
  G Coetzee.  Smith 308.
- Integrated analysis and visualization of ChIP-seq data using
  ChIPpeakAnno, GeneNetworkBuilder and TrackViewer. Jianhong Ou and Lihua Julie Zhu
  (University of Massachusetts Medical School) et al. Yawkey 308.
- Multi-omics data representation and analysis with
  _MultiAssayExperiment_. Marcel Ramos (CUNY School of Public
  Health) et al. Yawkey 307.

**End-of-day** 

July 27, 5:30 - 7:30 [Residence Inn Fenway][]

- [Contributed posters](#contributed-poster-descriptions)

[Residence Inn Fenway]: https://goo.gl/maps/aC8qYg63a1A2

July 28, 5:00 - 7:00 Yawkey Conference Center
