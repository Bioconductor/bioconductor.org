...
<p><font color="red">Registration FULL</font>. Unfortunately, registration is completely full.</p>
...
- Present a [Developer Day lightning talk][apply-dday-lightning]
  (closes July 25).
...
- Interfaces for programming with data: making _Bioconductor_ software
  more analyst-friendly. Michael Lawrence (Genentech).
- Infrastructure for efficient storage and processing of large-scale
  ...
  and Epidemiology, Weill Cornell Medical College) et al.

**Workshops** (partial list)

- Contributing new packages. Lori Shepherd.
- Transitioning to git. Nitesh Turaga.
- Working with large data: DelayedArray. Herve Pages.
- Writing interactive applications. Sean Davis.
- _Bioconductor_ best practices. Martin Morgan.
- Self-directed hackathon
...
- [Contributed posters][poster-proposal]
