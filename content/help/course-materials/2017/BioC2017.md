...
Accommodation (special accommodation rates no longer available):

- [The Inn at Longwood][], 342 Longwood Ave, Boston, MA 02115. Mention
  _Bioconductor_ conference.
...
- Present a [poster][apply-poster] (closes July 15).
...
- Infrastructure for efficient storage and processing of large-scale
  single-cell genomics data (Developer-focused). Davide Risso
  (Division of Biostatistics and Epidemiology, Weill Cornell Medical
  College) et al.
...
- Infrastructure for efficient storage and processing of large-scale
  single-cell genomics data (User-focused). Davide Risso (Division of
  Biostatistics and Epidemiology, Weill Cornell Medical
  College). Yawkey 306.
...
- CyTOF workflow: differential discovery in high-throughput
  high-dimensional cytometry datasets. Malgorzata Nowicka et
  al. Yawkey 306.
...
- Working effectively with multi-omics data. Levi Waldron (CUNY School
  of Public Health). Yawkey 307.

**End-of-day social** including [contributed posters][poster-proposal]
(July 27).
