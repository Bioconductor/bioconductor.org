...
High-throughput sequencing generates datasets consisting of hundreds
...
* Check out the [source code for BiocParallel]
(http://github.com/Bioconductor/BiocParallel) from github.
