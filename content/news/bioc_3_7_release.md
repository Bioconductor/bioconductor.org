...
Version: 2018.04.18
Category: Using the new method to scan motif inthe genome, remove
...
Version: 0.5.13
Text: Small bug fixes

Version: 0.5.12
Text: Small bug fixes

Version: 0.5.11
Text: Fixed calls to `sapply` and `1:n`

Version: 0.5.10
Text: Adding GO CC is now in `dontrun`, takes too long (12s)

Version: 0.5.9
Text: Fixed vignette: converted pdf images to eps and added them

Version: 0.5.8
Text: Removed `broser()` calls

Version: 0.5.8
Text: Removed some commented code

Version: 0.5.8
Text: Expanded doc on `launchApp`

Version: 0.5.8
Text: Removed the old gone report functionality in the app (might bring
        it back eventually)

Version: 0.5.8
Text: Added captures of the graphical interface to the main vignette

Version: 0.5.7
Text: Slight changes in vignette (affiliations)

Version: 0.5.7
Text: Fixed `generateEnzymesTable`: now it can also add the GO terms
        inside each enzyme

Version: 0.5.7
Text: Modified `addGOToGraph`: now it will add only the GO labels,
        without similarity score, provided that `GOterm = NULL`

Version: 0.5.7
Text: Improved doc in result exports: `generateResultsTable`,
        `generateEnzymesTable`, `generateResultsGraph`, `addGOToGraph`
        and `plotGraph`. - Merged all the doc - Added references -
        Expanded details

Version: 0.5.6
Text: Improved doc in enrichment techniques: - Merged 5 functions:
        `defineCompounds`, `runHypergeom`, `runDiffusion`,
        `runPagerank`, `enrich` - Expanded details: formulation, how to
        compute scores, null model - Added references - Centralised
        examples

Version: 0.5.6
Text: References are now in template files

Version: 0.5.5
Text: Improved doc in `FELLA.DATA` object creation - Fused 3 functions
        - Added references - Expanded details

Version: 0.5.4
Text: Added progress bars to shiny app for: - Loading database -
        Enriching - Adding GO similarity

Version: 0.5.4
Text: Added simple legend for GO similarity

Version: 0.5.3
Text: Added `CITATION` file

Version: 0.5.3
Text: Added some cites to doc

Version: 0.5.2
Text: Shiny app - Fixed bug: table not showing up - Documentation has
        been improved - Fixed bug: empty network led to error - Now
        exporting a network takes into account
        `thresholdConnectedComponent` as well (it did not until now) -
        Modified logo size and title

Version: 0.5.1
Text: Small modifications on Travis and `is-.R`

Version: 0.5.0
Text: Fixed bibliography in vignette

Version: 0.5.0
Text: Fixed missing table in vignette

Version: 0.5.0
Text: Changed mechanisms when handling existing directories.  Now the
        writing is stopped instead of overwriting and the automatic
        names are more meaningful.

Version: 0.5.0
Text: New naming convention for databases.  Meaningful names with
        creation date, organism and KEGG version.

Version: 0.5.0
Text: Updated unit testing and argument checking accordingly

Version: 0.4.13
Text: Temporarily downgraded R dependency to version 4.3

Version: 0.4.13
Text: Bug on the `biomaRt` query was actually due to their package
        being outdated. Updating fixed it.

Version: 0.4.13
Text: Small changes in functions (exports) to pass `check()`

Version: 0.4.13
Text: Small fixes on Shiny App

Version: 0.4.13
Text: Added vignette

Version: 0.4.12
Text: Travis modification

Version: 0.4.11
Text: Small changes on functions and DESCRIPTION

Version: 0.4.10
Text: Trying Travis

Version: 0.4.9
Text: Small changes in plotting functions

Version: 0.4.8
Text: Fixed the `FELLA.sample` file so that it contains the metadata

Version: 0.4.8
Text: Added the `getInfo` function for getting the metabata, with
        corresponding unit testing

Version: 0.4.8
Text: Fixed minor writing mistakes

Version: 0.4.8
Text: `loadMatrix` can no longer be `"all"`

Version: 0.4.8
Text: `AllArguments.R` now has `loadMatrix`, `databaseDir`,
        `internalDir`

Version: 0.4.8
Text: Shiny app: - Fixed the database error when no database is present
        - Fixed table error when the graph was empty (e.g. hypergeom) -
        Adding a GO term is now functional again.  Added several
        biomaRt/GO options. - GO term changes plot legend - Changes in
        the UI (text, new widgets for GO term) - GO example autofills
        all the new widgets

Version: 0.4.7
Text: Improved vignette text and added Bioconductor style

Version: 0.4.7
Text: Added `BiocStyle` as a dependency To do:

Version: 0.4.7
Text: General check of arguments and documentation

Version: 0.4.7
Text: Quantitative input?

Version: 0.4.7
Text: Elaborate on this vignette or build another one for publication

Version: 0.4.6
Text: Removed the infamous `splitByCC` part (from `checkArguments`, the
        conditional on the `plot` method and from the vignette)

Version: 0.4.6
Text: Now the option is to filter out small CCs but still work with a
        single graph (`thresholdConnectedComponent` still exists).
        Therefore, function `generateResultsGraph` can only return a
        graph, being more intuitive.

Version: 0.4.5
Text: Modified size p-value computation.  Now it is more efficient and
        consistent

Version: 0.4.4
Text: Fused `checkArguments` into `AllArguments.R`

Version: 0.4.4
Text: Deleted the generic `summary` as it is not necessary.  Now the
        same can be achieved using `show` only, and this avoids method
        dispatch issues.

Version: 0.4.3
Text: Added the `summary` method for `FELLA.DATA` objects

Version: 0.4.3
Text: Fixed some dependencies in methods

Version: 0.4.3
Text: Separated `mytriangle` in function `plotGraph`

Version: 0.4.3
Text: Renamed functions (`is-.R`, `plotLegend.R`)

Version: 0.4.3
Text: Updated sample data documentation

Version: 0.4.2
Text: Added doc template for the statistical normalisation

Version: 0.4.2
Text: Removed p-values from table

Version: 0.4.2
Text: Improved `generateResultsTable` function

Version: 0.4.2
Text: Improved `runDiffusion` and `runPagerank` at the code level and
        avoided checking arguments

Version: 0.4.1
Text: Added accessor to `status` and substituted all the calls

Version: 0.4.1
Text: Addition of GO terms works

Version: 0.4.0
Text: Removed some superfluous arguments: askplots, filename, BIMODAL

Version: 0.4.0
Text: Aggregated `get-.R` and `list-.R` functions in single files

Version: 0.4.0
Text: Cleaned part of: `AllMethods`, `exportResults`, `generate-`

Version: 0.4.0
Text: Fixed unit testing

Version: 0.4.0
Text: Fixed runnable examples

Version: 0.4.0
Text: Fixed vignette

Version: 0.4.0
Text: Rebuilt example data

Version: 0.4.0
Text: Improved argument handling. `method` can no longer be `"all"` and
        handles a unique method now, but `methods` can pass a vector of
        methods instead

Version: 0.4.0
Text: Passes `check()` and `BiocCheck(".")`

Version: 0.3.3
Text: Improved argument documentation (still work to do)

Version: 0.3.3
Text: Fused individual dummy functions that contained the commented
        parameters

Version: 0.3.3
Text: Added `list-()` functions

Version: 0.3.3
Text: Removed `p.adjust` from diffusion and pagerank

Version: 0.3.3
Text: Improved unit testing To do:

Version: 0.3.3
Text: Fix documentation of changed functions

Version: 0.3.3
Text: Try to better isolate functions (e.g. `plot` and
        `generateResultsGraph` do too many things at once...)

Version: 0.3.3
Text: Quantitative input?

Version: 0.3.3
Text: Delete repetitive code

Version: 0.3.3
Text: Use `checkArguments` in main functions

Version: 0.3.3
Text: Improve `AllMethods`: use accessors, clean code...

Version: 0.3.2
Text: Switched from `pValues` to `pScores` (except in `hypergeom`)

Version: 0.3.1
Text: Removed `rcytoscapejs` dependency

Version: 0.3.0
Text: Fixed vignette

Version: 0.3.0
Text: Modifications to several functions, addressing: - Proper handling
        of GO labels - now can be used in many species -
        `addCellularComponentToGraph` is now `addGOToGraph` - New
        dependency: biomaRt - Plotting functions have been simplified,
        but still need work - Graph building has been improved

Version: 0.3.0
Text: Shiny app: - Removed tabs, has only 4 now - Left only interactive
        plot - Table is now from `DT` To do:
...
Version: 0.3.0
Text: Improve function documentation (use templates) to supress
        warnings

Version: 0.3.0
Text: Change `rcytoscapejs` dependency to `visNetwork` (in CRAN)

Version: 0.3.0
Text: What to do about the p-values?

Version: 0.2.6
Text: Fixed indentation

Version: 0.2.6
Text: Fixed long lines

Version: 0.2.6
Text: Added NEWS file

Version: 0.2.6
Text: Fixed examples To do:

Version: 0.2.6
Text: Vignette breaks, top priority
...
Version: 0.2.5
Category: Some minor changes to accomodate Bioconductor's standards
Text: Update `R` version

Version: 0.2.5
Category: Some minor changes to accomodate Bioconductor's standards
Text: Add `R` file to the `testthat` folder

Version: 0.2.5
Category: Some minor changes to accomodate Bioconductor's standards
Text: Add GO biocView

Version: 0.2.5
Category: To do from Bioconductor
Text: Vignette breaks
...
Version: 0.2.5
Category: To do from Bioconductor
Text: Fix long lines (<80)

Version: 0.2.5
Category: To do from Bioconductor
Text: Add runnable examples: - buildDataFromGraph -
        buildGraphFromKEGGREST - loadKEGGdata
...
Version: 0.2.4
Text: Minor tweaks in the plotting function. Has more flexibility and
        can use `tkplot` as well (for image generation purposes), or
        force layout. This function should be really improved, it's not
        that hard...

Version: 0.2.3
Text: Fixed CREB website link

Version: 0.2.3
Text: Added the option to specify the damping factor in pagerank

Version: 0.2.3
Text: Changed default damping factor to 0.85

Version: 0.2.2
Text: Fixed table export (`stringsAsFactors` was not disabled when
        creating the data.frame).

Version: 0.2.2
Text: Added the function `generateEnzymesTable` to build a table with
        the EC numbers, along with the genes (entrez) within them and
        the associated GO labels (http://www.geneontology.org/).

Version: 0.2.2
Text: The shiny app exports tables with the full enzyme data and simply
        as a text gene list as well.

Version: 0.2.1
Category: The shiny app has been updated.
Text: Now the rcytoscape part has clickable links.  This is due to a
        change in the r-cytoscape.js
        (https://github.com/cytoscape/r-cytoscape.js/) package that
        changes the `href` node attribute to `tooltip`.

Version: 0.2.1
Category: The shiny app has been updated.
Text: The colors and shapes have been updated as well, to be consistent
        with our notation.

Version: 0.2.1
Category: To do
Text: The labels of the nodes are not sorted by length.  Short labels
        can be really weird...

Version: 0.2.0
Category: Added the shiny app as a developer option. It requires the
        following packages
Text: shiny
...
Version: 0.0.999
Category: This is the first version of this package. It contains:
Text: Basic enrichment functions: hypergeom, diffusion, pagerank

Version: 0.0.999
Category: This is the first version of this package. It contains:
Text: Null models: normal or Monte Carlo

Version: 0.0.999
Category: This is the first version of this package. It contains:
Text: Export options: to tables or graphs

Version: 0.0.999
Category: This is the first version of this package. It contains:
Text: Plotting capabilities

Version: 0.0.999
Category: This is the first version of this package. It contains:
Text: Possibility of custom background

Version: 0.0.999
Category: Further versions should include interactive plots and
Text:

Version: 0.0.999
Category: applications for an easier usage
Text:
...
- Prepare for Bioconductor sumbission

Changes in version 0.3.0:

- Novel plotCorAcrossRef integration

- Add q-value estimation option

- Allow including annotation to MultiAssayExperiment

- Major documentaiton update

Changes in version 0.2.1:

- Main update: MultiAssayExperiment data integration

- Switch to gene coordinates by default

- Default option to find genes closest to TAD
...
Version: 2017-04-24
Text: Corrected a mistake in extractSplicingEnrichment() and
        extractConsequenceEnrichment() which caused p-values to be
        corrected for multiple testing with Holms methods instead of
        BH/FDR (which it is now).

Version: 2017-04-23
Text: Small update to importRdata which in rare circumstances could
        cause an error (J1 not found)

Version: 2017-04-17
Text: The preFilter function was updated to only allow filtering on
        mean expression/usage (gene expression, isoform expression and
        isoform usage) accross all samples since filtering on individal
        conditions can lead to loss of false discovery rate.  For more
        information refere to
        https://www.nature.com/articles/nmeth.3885 and the IWH
        Bioconductor package.  Therefore

Version: 2017-04-17
Text: All import* functions was updated to include calculation of these
        means.

Version: 2017-04-17
Text: All example data was updated to include these meanse.

Version: 2017-04-17
Text: Relevant documentation was updated to include description of
        these means

Version: 2017-04-17
Text: Vignette was updated to reflect these changes

Version: 2017-04-17
Text: The importRdata() was updated to better handle differences in
        which isoforms have been quantified and which isoforms are in
        the GTF and quantifications.

Version: 2017-04-17
Text: Information on how to install from the developmental branch of
        Bioconductor was added to vignette.

Version: 2017-04-17
Text: Small updates to make error messages more informative

Version: 2017-04-17
Text: Update of unclear import error message

Version: 2017-04-17
Text: Updated FAQ in vignette

Version: 2017-04-04
Text: A bug was fixed in analyzeIntronRetention() so it now works.

Version: 2017-04-04
Text: All import functions (importRdata and importGTF) now per default
        import CDS as ORF if a GTF file is suppled.

Version: 2017-04-04
Text: Small corrections in vignette.

Version: 2017-04-04
Text: Improved NEWS layout

Version: 2017-03-28
Text: We are very pleased to introduce a splicing modul for the
        analysis of isoform switches which allows for thorough analysis
        of alternative splicing, alternative transcription start sites
        and alternative transcription termination sites. Although the
        core of this modul is a liftover of the main functions form the
        now decapitated R pacakge spliceR we have made several new post
        analysis directly available. The introduction does however
        cause a few changes:

Version: 2017-03-28
Text: The main function for analyzing alternative splicing (including
        intron retention) is now the analyzeAlternativeSplicing()
        function (although analyzeIntronRetention() is keept for
        backward compatability).

Version: 2017-03-28
Text: The resulting analysis is stored in the
        'AlternativeSplicingAnalysis' entry of the switchAnalyzeRlist
        (instead of under 'IntronRetentionAnalysis')

Version: 2017-03-28
Text: IsoformSwitchAnalyzeR have been extensively updated with build in
        functions for global analysis of consequences and splicing.
        Here we introduce the following function:

Version: 2017-03-28
Text: extractSwitchOverlap() : Visualizes the overlap in switching
        features in different comparisons

Version: 2017-03-28
Text: extractConsequenceEnrichment() : Analyze for enrichment of either
        of opposite consequences (e.g. more protein domain loss than
        gain?)

Version: 2017-03-28
Text: extractConsequenceEnrichmentComparison() : Comparare enrichment
        of either of opposite consequences (e.g. more protein domain
        loss than gain?) between comparisons

Version: 2017-03-28
Text: extractSplicingSummary() : Global summary of alternative splicing
        events

Version: 2017-03-28
Text: extractSplicingEnrichment() : Analyze for enrichment of either of
        opposite consequences (e.g. more exon skipping than exon
        inclusion?)

Version: 2017-03-28
Text: extractSplicingEnrichmentComparison() : Comparare enrichment of
        either of opposite consequences (e.g. more exon skipping than
        exon inclusion?) between comparisons

Version: 2017-03-28
Text: extractGenomeWideSplicingAnalysis() : Global analysis of changes
        in isoform fraction of isoforms with a specific splice patterns
        (e.g. exon skipping)

Version: 2017-03-28
Text: The example data 'exampleSwitchListAnalyzed' included in
        IsoformSwitchAnalyzeR was exchanged to a dataet which better
        illustrate the usefullness of the analysis that can be done.

Version: 2017-03-28
Text: The vignette were updated to reflect these changes with a whole
        section of analysis of alternative splicing.

Version: 2017-03-28
Text: The vignette also got a thorough workover.

Version: 2017-03-28
Text: The getCDS spliceR function and CDSset class was lifted over and
        updated to the current UCSC genome browser layout.

Version: 2017-03-28
Text: isoformSwitchTest() was updated so it only callibrates p-values
        if all comparisons meet the requirements.

Version: 2017-03-28
Text: The switchPlotTranscript() was updated to handle condition names
        is a perfect substring of another condition name.

Version: 2017-03-28
Text: Small improvements in documentations

Version: 2017-03-06
Text: The importIsoformExpression() function was improved to handle
        file names with costom pre-fixes and now adds the 'isoform_id'
        column itself making the matrixes directly compatible with
        importRdata().

Version: 2017-03-06
Text: Various small imporvements in documentation.

Version: 2017-03-01
Text: Fixed a problem which could cause signal peptides not to be
        plotted - we highly remend redoing switchPlots (only the
        visualizations were affected - not the underlying analysis).
        Thanks to Maxim Ivanov for discovring the problem.

Version: 2017-03-01
Text: Added indication of update importance (minor/major)
        retrospectively to the NEWS.

Version: 2017-02-27
Text: Small updates to the switchPlot* functions making them more
        robust to edge cases

Version: 2017-02-27
Text: Fixed a problem in the assignment of NAs to isoforms without
        ORFs. The example datasets were updated accordingly.

Version: 2017-02-27
Text: Various small imporvements for robustness.

Version: 2017-02-21
Text: Update to accommodate analysis of no-replicate pilot experiments
        (see guide in vignette)

Version: 2017-02-21
Text: Various small bug-fixes

Version: 2017-12-19
Text: (The large version-bump is due to the release of the next
        itteration of Bioconductor)

Version: 2017-12-19
Text: Corrections for a lot of spelling mistakes in the package - huge
        shoutout to @khoegenauer for the suggestions

Version: 2017-12-19
Text: A few small updates to import functions making the progress even
        smoother
...
Version: 2016-09-01
Text: We are proud to introduce IsoformSwitchAnalyzeR - fresh out of
        in-house beta version.
...
- XPSData.h - correct selassignment
...
- update XPSPreProcessing.cxx to reset mask to initial values for each
  array (necessary for whole genome/exon arrays)

VERSION xps-1.25.1

- update XPSPreProcessing.cxx to remove -Wsequence-point warning for
  numsels = ++numsels
...
- add type CNRTYPE to image() and hist()
...
[RnaSeqSampleSizeData](https://bioconductor.org/packages/RnaSeqSampleSizeData)
--------------------
