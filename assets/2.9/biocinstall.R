biocinstallRepos <- function()
{
    ...
    repos <- paste("http://bioconductor.org/packages", repos, sep="/")
##     c(repos, "http://brainarray.mbni.med.umich.edu/bioc", "http://cran.fhcrc.org")
    c(repos, "http://cran.fhcrc.org")    
}
...
### biocinstall() version 2.4.13
### Called by biocLite() when R version 2.9 is detected.
###
                        ...
                        dependencies=c("Depends", "Imports"), type=getOption("pkgType"), ...)
{
    ...
    VERSION <- "2.4.13"        # this script version
    BIOC_VERSION <- "2.4"      # this version of Bioconductor
    ## R version 2.9 should have been detected by biocLite()
