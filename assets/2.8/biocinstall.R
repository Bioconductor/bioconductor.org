biocinstallRepos <- function()
{
    ...
    repos <- paste("http://bioconductor.org/packages/2.3", repos, sep="/")
...
### biocinstall() version 2.3.14
### Called by biocLite() when R version 2.8 is detected.
###
                        ...
                        dependencies=c("Depends", "Imports"), type=getOption("pkgType"), ...)
{
    ...
    VERSION <- "2.3.14"
    ## R version 2.8 should have been detected by biocLite()
    ...
    cat("Your version of R requires version 2.3 of Bioconductor.\n")
