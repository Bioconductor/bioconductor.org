message('BioC_mirror = ',
        getOption("BioC_mirror", "http://www.bioconductor.org"),
...
#    repos <- c(repos, "http://brainarray.mbni.med.umich.edu/bioc", "http://cran.fhcrc.org")
...
### biocinstall() version 2.6.10
### Called by biocLite() when R version 2.11 is detected.
###
...
biocinstall <- function(pkgs, groupName="default", repos, ...)
{
    ...
    VERSION <- "2.6.10"               # this script version
    BIOC_VERSION <- "2.6"            # this version of Bioconductor
